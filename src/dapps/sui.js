...
export default function SuiDApp() {
  ...
  async function signTransactionBlock(){
    ...
    */
    ...
    let signTransactionBlock = provider.features['sui:signTransactionBlock'].signTransactionBlock;
  ...
  async function signAndExecuteTransactionBlock(){
    ...
    let signAndExecuteTransactionBlock = provider.features['sui:signAndExecuteTransactionBlock'].signAndExecuteTransactionBlock;
  ...
  return (<>
    ...
    <div className="dapp-part">
      <div>bitget sui: <a href="https://web3.bitget.com/zh-CN/docs/provider-api/sui.html">https://web3.bitget.com/zh-CN/docs/provider-api/sui.html</a></div>
      <div>sui: <a href="https://docs.sui.io/guides/developer/sui-101/building-ptb">https://docs.sui.io/guides/developer/sui-101/building-ptb</a></div>
      <div>sui sign: <a href="https://docs-zh.sui-book.com/concepts/cryptography/transaction-auth/signatures/">https://docs-zh.sui-book.com/concepts/cryptography/transaction-auth/signatures/</a></div>
    </div>
    ...
    }}>signAndExecuteTransactionBlock</button>
    </div>
    ...
    {
        (type === 'send' && txId) 
        && <div>交易记录: <a href={ 'https://suiexplorer.com/txblock/' + txId + '?network=mainnet' }>
